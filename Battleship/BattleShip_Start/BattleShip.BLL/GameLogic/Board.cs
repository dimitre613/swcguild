...
namespace BattleShip.BLL.GameLogic
{
    public class Board
    {
        ...
        public void PrintShips()
        {
            ...
            {
                if (item == null) Console.WriteLine("");
                else Console.WriteLine(item.ShipName.ToString());
            }
        ...
        //{
        //    foreach (var item in ShotHistory)
        //    {
        //        //Console.WriteLine(string.Join(",",item.Key.ToString() + item.Value.ToString()));
        //    }
        //}
